...
st.title("AI Essay Detection System")
...
user_input = col1.text_area("Enter the essay you want to analyze", "", height = 200)
...
if pred :
    ...
    if prediction > 0.5:
        col1.write("<span style='font-size:30px'><b>The text is generated by AI.</b></span>", unsafe_allow_html=True)
        col1.image('the-rock-rock.gif')
    else:
        col1.write("<span style='font-size:30px'><b>The text is human-written.</b></span>", unsafe_allow_html=True)
